...
final class BlogPublicAssetContractTest extends TestCase
{
    ...
    public function testFallbackStylesheetIsNeutralResponsiveAndStandalone(): void
    {
        ...
        foreach ([
            ...
            '.blogArticleHero > .blogArticleHero-signature {',
            '.blogArticleHero-signature .blogArticleHero-author',
            '.blogArticleHero-signature .blogArticleHero-role::before',
            '.blogArticleHero-signature .blogArticleHero-date::before',
            '.blogArticleHero--basic > .blogArticleHero-signature',
            '.blogPublicArticleTaxonomies {',
            '.blogPublicArticleTaxonomies__group--tags',
            '.blogPublicArticleTaxonomies__item > span',
            'gap: clamp(1.5rem, 4vw, 3rem)',
            'border-block: 1px solid var(--ls-blog-border)',
