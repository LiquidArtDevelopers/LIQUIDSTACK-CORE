    ...
    public function render(
        ...
        $inspectorToggle = $inspector === null
            ...
            : '<button class="webadminShell-inspectorToggle" type="button" '
                ...
                . '<span class="webadminShell-toggleIcon" '
                . 'data-webadmin-toggle-icon aria-hidden="true">&rsaquo;</span>'
                . '<span class="webadminShell-visuallyHidden" '
                . 'data-webadmin-toggle-label>Cerrar herramientas</span>'
                . '</button>';
        ...
        $body = '<a class="webadminShell-skipLink" href="#webadmin-main">'
            ...
            . '<span class="webadminShell-toggleIcon" '
            . 'data-webadmin-toggle-icon aria-hidden="true">&lsaquo;</span>'
            . '<span class="webadminShell-visuallyHidden" '
            . 'data-webadmin-toggle-label>Cerrar men&uacute;</span></button>'
