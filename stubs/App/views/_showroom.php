            ...
            <main>
                ...
                */
                ...
                <section>
                    ...
                    // art02little (min/max):
                    // - items: 1 - 3 tarjetas.
                    // - variant: image | icon; los medios los define el índice en su JSON.
                    // - {header-primary}: acepta un encabezado externo y recalcula los secundarios.
                    // - {a-content}, {b-content}, {c-content}: aceptan cualquier sniper renderizado.
