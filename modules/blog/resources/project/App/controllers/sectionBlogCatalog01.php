...
/**
 * sectionBlogCatalog01: compositor del catalogo Blog sin copy derivado.
 ...
 * controladores LiquidStack. Como esta raiz ya aporta la seccion y su heading,
 * rechaza slots que intenten introducir otra `section` o `nav`; los recursos
 * hijos deben ser modulos de raiz neutra.
 */
function controller_sectionBlogCatalog01(
    int $i = 0,
    array $params = []
): string {
    ...
    $headingId = 'sectionBlogCatalog01-heading';
    $languageAttribute = $headerLang === ''
        ? ''
        : ' data-lang="' . $escape($headerLang) . '"';

    return render('App/templates/_sectionBlogCatalog01.html', [
