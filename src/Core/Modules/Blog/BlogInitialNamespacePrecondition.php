...
/** Rejects adoption or implicit repair of a pre-existing Blog namespace. */
final class BlogInitialNamespacePrecondition implements
    MigrationPreconditionVerifierInterface
{
    public function contractVersion(): string
    {
        return 'blog-initial-namespace-empty-v1';
    }
