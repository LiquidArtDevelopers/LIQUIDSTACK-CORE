...
- Ejecuta `composer update liquidstack/core` para recibir la configuración y las skills base. Las skills locales deben usar nombres de carpeta distintos a los gestionados por CORE.
